...
public sealed class UpdateQuizCoverCommandHandler(
    IQuizRepository quizRepository,
    IMemberRepository memberRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
    : IRequestHandler<UpdateQuizCoverCommand, QuizDto>
{
    public async Task<QuizDto> Handle(UpdateQuizCoverCommand request, CancellationToken cancellationToken)
    {
        ...
        quiz.UpdateCover(request.CoverImageUrl, request.CoverEmoji, request.CoverGradient);
