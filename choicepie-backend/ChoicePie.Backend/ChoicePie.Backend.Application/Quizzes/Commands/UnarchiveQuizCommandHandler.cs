...
public sealed class UnarchiveQuizCommandHandler(
    IQuizRepository quizRepository,
    IMemberRepository memberRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
    : IRequestHandler<UnarchiveQuizCommand, QuizDto>
{
    public async Task<QuizDto> Handle(UnarchiveQuizCommand request, CancellationToken cancellationToken)
    {
